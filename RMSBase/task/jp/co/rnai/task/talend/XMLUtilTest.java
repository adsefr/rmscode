...
public class XMLUtilTest {
	...
	private static void testGetValueExceptTags() throws XPathExpressionException, SAXException, IOException,
		...
		content = "<ce:ArticleTitle xmlns:ce=\"http://www.elsevier.com/xml/common/dtd\">The Low‐Temperature Cosintering of<ce:p> Cobalt<ce:sub>sub<ce:inf loc='loc'>inf</ce:inf></ce:sub>Ferrite<ce:sup>sup<ce:inf>inf</ce:inf></ce:sup><ce:b>bf<ce:sup>sup</ce:sup><ce:b>b</ce:b><ce:i>i</ce:i>  "
				+ "		<ce:u>  u</ce:u></ce:b><ce:i>i</ce:i><ce:u>u</ce:u></ce:p> and Lead Zirconate Titanate Ceramic Composites</ce:ArticleTitle>";

		content = "<titletext xml:lang=\"eng\" original=\"y\">Multiple transformation with the crtYB gene of the limiting enzyme increased carotenoid synthesis and generated novel derivatives in Xanthophyllomyces dendrorhous</titletext>";

		content = XMLUtil.trimTag(content);
