...
public class JobUtils {
	...
	public final static String PROOF_TAGET_DB = "PROOF_TAGET_DB";
	...
	private static String printProofJDBCOutput(Properties context, final Map<String, Object> globalMap, String origin) {
		...
		builder.append(format(context.getProperty(PROOF_TAGET_DB), globalMap.get(CURRENT_TABLE)));
		builder.append(LINE_SEPERATOR);
