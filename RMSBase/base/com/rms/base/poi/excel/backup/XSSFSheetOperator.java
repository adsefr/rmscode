...
import com.rms.base.poi.excel.object.AbstractSheetOperator;
 ...
 * @since 2015/03/27
 */
class XSSFSheetOperator extends AbstractSheetOperator {
	...
	public SheetOperator setMaxRowIndex(int maxRowIndex) {
		...
		if (!excelOperator.isValidRowNumber(maxRowIndex)) {
	...
	public SheetOperator setMaxColumnIndex(int maxColumnIndex) {
		...
		if (!excelOperator.isValidColumnNumber(maxColumnIndex)) {
	...
	public SheetOperator setCurrRowIndex(int currRowIndex) {
		...
		if (!excelOperator.isValidRowNumber(currRowIndex) || currRowIndex > getMaxRowIndex()) {
	...
	public SheetOperator setCurrColumnIndex(int currColumnIndex) {
		...
		if (!excelOperator.isValidRowNumber(currColumnIndex) || currColumnIndex > getMaxColumnIndex()) {
